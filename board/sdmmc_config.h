...
#define BOARD_SDMMC_SD_HOST_BASEADDR   USDHC2
#define BOARD_SDMMC_SD_HOST_IRQ        USDHC2_IRQn
#define BOARD_SDMMC_MMC_HOST_BASEADDR  USDHC2
#define BOARD_SDMMC_MMC_HOST_IRQ       USDHC2_IRQn
#define BOARD_SDMMC_SDIO_HOST_BASEADDR USDHC2
#define BOARD_SDMMC_SDIO_HOST_IRQ      USDHC2_IRQn
