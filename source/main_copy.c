...
//
//    if (pdPASS !=
//        xTaskCreate(CardDetectTask, "CardDetectTask", 512, NULL, 4, NULL))
//    {
//        return -1;
//    }
//
...
//
//    BOARD_SDIO_Config(&g_sdio, NULL, BOARD_SDMMC_SDIO_HOST_IRQ_PRIORITY, NULL);
//    /*
...
//#if 1
//    PRINTF("bb\n");
//    MySDIO_SetCardPower(&g_sdio, false);
//	vTaskDelay(100);
//	/* power on the card */
//	MySDIO_SetCardPower(&g_sdio, true);
//	vTaskDelay(100);
//    if (SDIO_Init(&g_sdio)){
//    	PRINTF("SDIO_Init failed\n");
//    }else{
//    	PRINTF("init success\n");
//    }
//    while(1);
